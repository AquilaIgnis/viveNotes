...
object MaterialSymbols {
    ...
    val ChevronRight: ImageVector @Composable get() = symbol(R.drawable.ms_rounded_chevron_right)
    val Close: ImageVector @Composable get() = symbol(R.drawable.ms_rounded_close)
    val Cloud: ImageVector @Composable get() = symbol(R.drawable.ms_rounded_cloud)
    val CloudDownload: ImageVector @Composable get() = symbol(R.drawable.ms_rounded_cloud_download)
    ...
    val Logout: ImageVector @Composable get() = symbol(R.drawable.ms_rounded_logout)
